    ...
    switch(modalidade)
    {
        ...
        case 1:
            ...
            if (nacionalidade == 1 && idade>14)
            {
                ...
                switch (filme)
                {
                    ...
                    //Tropa de Elite 2
                    case 2:
                        printf("Sinopse: Depois de uma operacao fracassada, Nascimento e afastado do BOPE e agora trabalha como subsecretario de Inteligencia na Secretaria de Segurança Publica do Rio de Janeiro. No novo cargo, o ex-capitao e arrastado para uma disputa politica sangrenta que envolve funcionarios do governo e grupos paramilitares.\n");
                    ...
                    //O Doutrinador
                    case 5:
                        printf("Sinopse: Um vigilante mascarado surge para atacar a impunidade que permite que politicos e donos de empreiteiras enriqueçam as custas da miseria e do trabalho da populacao brasileira. A historia do homem por tras do disfarce de Doutrinador envolve uma jornada pessoal de vinganca na qual um agente traumatizado decide fazer justica com as proprias maos.\n");
                    ...
                    //2 Coelhos
                    case 6:
                        printf("Sinopse: Preso entre a criminalidade e o poder público corrupto, Edgar está cansado dessa vida e planeja fazer justiça com as próprias mãos. Ele executa um plano que coloca criminosos e corruptos em rota de colisão.\n");
            ...
            else if (nacionalidade == 1 && idade<=14)
            {
                ...
                switch (filme)
                {
                    ...
                    //Bacurau
                    case 4:
                        printf("Sinopse: Pouco apos a morte de dona Carmelita, aos 94 anos, os moradores de um pequeno povoado localizado no sertao brasileiro, chamado Bacurau, descobrem que a comunidade nao consta mais em qualquer mapa. Aos poucos, percebem algo estranho na regiao: enquanto drones passeiam pelos ceus, estrangeiros chegam a cidade pela primeira vez. Quando carros se tornam vitimas de tiros e cadaveres começam a aparecer, os habitantes chegam a conclusao de que estao sendo atacados.\n");
            ...
            else if (nacionalidade == 2 && idade>14)
            {
                ...
                switch(filme)
                {
                    ...
                    //Sem Remorso
                    case 3:
                        printf("Sinopse: Um fuzileiro naval de elite descobre uma conspiracao internacional enquanto busca justiça pelo assassinato de sua esposa gravida.\n");
            ...
            else if (nacionalidade == 2 && idade<=14)
            {
                ...
                //Vingadores Ultimato
                case 1:
                    printf("Sinopse: Apos Thanos eliminar metade das criaturas vivas, os Vingadores tem de lidar com a perda de amigos e entes queridos. Com Tony Stark vagando perdido no espaço sem agua e comida, Steve Rogers e Natasha Romanov lideram a resistencia contra o tita louco.\n");
                ...
                //Capita Marvel
                case 3:
                    printf("Sinopse:  Capita Marvel, parte do exercito de elite dos Kree, uma raça alienigena, encontra-se no meio de uma batalha entre seu povo e os Skrulls. Ao tentar impedir uma invasao de larga escala na Terra, em 1995, ela tem memorias recorrentes de uma outra vida, como Carol Danvers, agente da Força Aerea norte-americana. Com a ajuda de Nick Fury, Capita Marvel precisa descobrir os segredos de seu passado e por um fim ao conflito intergalatico com os Skrulls.\n");
        ...
        case 2:
            ...
            if (nacionalidade == 1 && idade>14)
            {
                ...
                switch (filme)
                {
                    ...
                    case 6:
                        ...
                        printf("Principais Atores: Irandhir Santos, Rita Carelli, Sílvio Restiffe\n");
                        printf("Faixa etaria: 16 anos\n");
            ...
            else if (nacionalidade == 1 && idade<=14)
            {
                ...
                switch (filme)
                {
                    //Casa Grande
                    case 1:
                        printf("Sinopse: Sonia e Hugo sao da alta burguesia carioca e levam uma vida bastante confortavel. Aos poucos vão a falencia, mas ninguem sabe de seus problemas financeiros, nem mesmo o filho Jean, que faz de tudo para se desvencilhar dos pais superprotetores. Para se manter, o casal corta despesas e ele, que so se preocupava com garotas e vestibular, enfrenta pela primeira vez a realidade.\n");
            ...
            else if (nacionalidade == 2 && idade>14)
            {
                ...
                switch(filme)
                {
                    ...
                    //Mom
                    case 5:
                        printf("Sinopse: A enteada dela sofreu abuso sexual numa festa. Os quatro criminosos não contavam com a furia desta mae, que faz de tudo para destruir suas vidas.\n");
            ...
            else if (nacionalidade == 2 && idade<=14)
            {
                ...
                //A Menina E O Leao
                case 3:
                    printf("Sinopse:  Mia eh uma jovem de 14 anos que sempre teve uma profunda amizade com Charlie, um leao branco da fazenda de sua familia. Um dia, seu pai decide vender o felino para cacadores de trofeus e ela não ve outra opcao alem de fugir com Charlie para salva-lo.\n");
        ...
        case 3:
            ...
            if (nacionalidade == 1 && idade>14)
            {
                ...
                switch (filme)
                {
                    //O Cheiro Do Ralo
                    case 1:
                        printf("Sinopse: Lourenço eh proprietario de uma loja de penhores e se sustenta desenvolvendo um jogo perverso com seus clientes, geralmente em dificuldades financeiras. Tudo muda quando ele conhece uma garçonete e comeca a perder o controle de sua vida.\n");
            ...
            else if (nacionalidade == 2 && idade>14)
            {
                ...
                switch(filme)
                {
                    ...
                    case 5:
                        ...
                        printf("Duracao: 1h 41min\n");
                        printf("Pais e Ano: França, 2018\n");
                        break;
                    //Ted
                    case 6:
                        printf("Sinopse: Quando crianca, John desejou que seu ursinho Ted ganhasse vida e, surpreendentemente, foi atendido. Porem, agora que eh adulto, ele precisa lidar com as consequencias de seu pedido, ja que Ted não vai parar de atormentar a sua vida.\n");
            ...
            else if (nacionalidade == 2 && idade<=14)
            {
                ...
                //Meninas Malvadas
                case 1:
                    printf("Sinopse: A adolescente Cady Heron foi educada na Africa pelos seus pais cientistas. Quando sua familia se muda para o suburbio, nos Estados Unidos, Cady começa a frequentar a escola publica e recebe uma rapida introdução as leis de popularidade que dividem seus colegas. Sem querer, ela acaba no meio de um grupo de elite de estudantes apelidadas as poderosas.\n");
        ...
        case 4:
            ...
            if (nacionalidade == 1 && idade>14)
            {
                ...
                //Amores Possiveis
                    ...
                    case 4:
                        printf("Sinopse: Adriana, uma escritora bem-sucedida, segue feliz em seu romance com Andre, que esta prestes a lançar sua mais nova coleção de moda durante um cruzeiro pelo Caribe. Ao saber que a ex-noiva dele vai acompanha-lo na viagem em busca de uma reconciliacao, Adriana chama suas fieis escudeiras Luzia e Dialinda para embarcar no navio com eles.\n");
                    ...
                    //Paraiso Perdido
                    case 6:
                        printf("Sinopse: Paraiso Perdido e um clube noturno gerenciado por Jose (Erasmo Carlos) e movimentado por apresentações musicais de seus herdeiros. O policial Odair (Lee Taylor) se aproxima da familia ao ser contratado para fazer a segurança do jovem talento Ima (Jaloo), neto de Jose e alvo frequente de homofobicos, e aos poucos o laco entre o agente e o cla de artistas romanticos vai se revelando mais e mais forte - com nos surpreendentes.\n");
            ...
            else if (nacionalidade == 1 && idade<=14)
            {
                ...
                //Cinderela Pop
                    case 1:
                        printf("Sinopse: Cintia Dorella e romantica menina de 16 anos que sonha em encontrar o cara ideal, mas ve seu mundo ruir quando descobre que seu pai esta traindo sua mae. Descrente no amor, ela vai morar na casa da tia e passa a trabalhar como DJ, se tornando a Cinderela Pop. Com a vida virada de cabeça para baixo, Cintia acaba se apaixonando por Freddy, um cantor de sucesso e verdadeiro príncipe encantado dos dias atuais, mas tambem precisa lidar com as filhas de sua madrasta, que tambem desejam o rapaz.\n");
                        printf("Principais Atores:Maisa Silva, Filipe Bragança, Fernanda Paes Leme\n");
                        printf("Faixa etaria: Livre\n");
                    ...
                    case 2:
                        printf("Sinopse: Depois de ser desprezada pelo namorado mimado e mulherengo, Tati busca maneiras de reconquista-lo. Para isso, ela procura Conrado, um professor de biologia que defende uma polêmica tese sobre as conquistas afetivas humanas e as atitudes dos animais.\n");
                    ...
                    //Amor.com
                    case 5:
                        printf("Sinopse: Katrina e uma famosa blogueira de moda que dita tendencias no mercado brasileiro atraves de seus populares videos na internet. Fernando, por sua vez, e um vlogueiro de um canal de videogames que ainda nao e muito famoso, mas que ja esta fazendo certo sucesso. Quando os dois se conhecem, em uma situação complicada, acabam se apaixonando e o romance dos dois ganha destaque na internet.\n");
                    ...
                    case 6:
                        printf("Sinopse: Leonardo, um adolescente cego, tenta lidar com a mae superprotetora ao mesmo tempo em que busca sua independencia. Quando Gabriel chega em seu colegio, novos sentimentos começam a surgir em Leonardo, fazendo com que ele descubra mais sobre si mesmo e sua sexualidade.\n");
            ...
            else if (nacionalidade == 2 && idade>14)
            {
                ...
                //Perfeita pra Voce
                    case 1:
                        printf("Sinopse: Traduzido do inglês-Irreplaceable You é um filme americano de comédia dramática de 2018 dirigido por Stephanie Laing e escrito por Bess Wohl. O filme é estrelado por Gugu Mbatha-Raw e Michiel Huisman. Foi lançado pela Netflix em 16 de fevereiro de 2018.\n");
                    ...
                    //Alex Strangelove
                    case 5:
                        printf("Sinopse: O adolescente Alex Truelove (tem a vida perfeita – notas boas, namorada (Madeline Weinstein) e uma turma maluca e divertida. Tudo corre bem ate o dia em que ele decide perder a virgindade – e conhece Elliott, um garoto gay gentil e seguro de si mesmo que não tem medo de demonstrar seu interesse por Alex… que talvez sinta a mesma atraçao. Arremessado em uma incrível jornada de autodescoberta pessoal e sexual, Alex percebe que a vida e o amor podem ser complicados. E que tudo bem.\n");
                    ...
                    //Quase 18
                    case 6:
                        printf("Sinopse: Nadine esta enfrentando uma dificil situação desde que sua melhor amiga, Krista, esta namorando com o seu irmao mais velho, Darian. Nadine se sente mais sozinha do que nunca, ao menos ate começar uma amizade com um jovem atencioso.\n");
            ...
            else if (nacionalidade == 2 && idade<=14)
            {
                ...
                //Sol da Meia-Noite
                    case 1:
                        printf("Sinopse: Katie e uma jovem de 17 anos que vive protegida dentro de sua casa desde a infancia. Confinada no local durante os dias, ela possui uma rara doenca que faz com que a menor quantidade de luz solar seja mortal. Sua situação muda quando seu destino se cruza com o de Charlie e eles iniciam um romance de verao.\n");
                    ...
                    case 5:
                        printf("Sinopse: Hazel Grace Lancaster e Augustus Waters são dois adolescentes que se conhecem em um grupo de apoio para pacientes com cancer. Por causa da doenca, Hazel sempre descartou a ideia de se envolver amorosamente, mas acaba cedendo ao se apaixonar por Augustus. Juntos, eles viajam para Amsterda, onde embarcam em uma jornada inesquecivel.\n");
        ...
        case 5:
            ...
            if (nacionalidade == 1 && idade>14)
            {
                ...
                //1,99
                case 2:
                    printf("Sinopse: Em uma crítica a sociedade moderna, o filme concentra os acontecimentos em um mercado ficticio onde pessoas robotizadas compram produtos que, na verdade, sao slogans e sentimentos - nada de concreto.\n");
            ...
            else if (nacionalidade == 1 && idade<=14)
            {
                ...
                //Quem e Beta
                case 2:
                    printf("Sinopse: Depois de uma catastrofe destruir a sociedade civilizada, um casal começa uma nova vida em um abrigo. Sua missao e exterminar os seres contaminados, condenados a vagar como zumbis ate a morte.\n");
                ...
                //Os Cosmonautas
                case 4:
                    printf("Sinopse: Apos o sucesso da primeira missao espacial brasileira, um cientista pretende realizar um feito ainda mais audacioso. Seu objetivo e lancar ao espaço o foguete Nacionalista II, dessa vez levando dois humanos a lua.\n");
            ...
            else if (nacionalidade == 2 && idade<=14)
            {
                ...
                printf("5 - Star Wars: Episodio I – A Ameaça Fantasma\n");
        ...
        case 6:
            ...
            else if (nacionalidade == 2 && idade<=14)
            {
                ...
                //A Casa Monstro
                case 2:
                    printf("Sinopse: Nenhum adulto acredita quando tres adolescentes falam que existe uma casa no bairro que e uma criatura perigosa. Com o Dia das Bruxas se aproximando, eles tem que descobrir uma forma de destruir a casa antes que ela faça mal a criancas inocentes.\n");
